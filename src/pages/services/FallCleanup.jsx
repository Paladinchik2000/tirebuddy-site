            ...
            >
                ...
                <div className="relative z-10 px-6" data-aos="fade-up">
                    ...
                    <p className="text-lg md:text-xl text-slate-100 max-w-2xl mx-auto">
                        Reliable fall yard clean-up across the GTA — keeping your property neat, safe, and ready for winter.
                    </p>
                </div>
            </section>
            ...
            <section className="max-w-5xl mx-auto px-4 py-20 text-slate-700 leading-relaxed">
                <div data-aos="fade-up" data-aos-delay="100">
                    <p className="text-lg mb-6">
                        We offer <strong>reliable fall yard clean-up services across the GTA</strong>, perfect for keeping your
                        property neat and ready for winter. All work is completed by a{" "}
                        <strong>2-person team</strong> using professional equipment — rakes, trimmers, and leaf blowers.
                    </p>
