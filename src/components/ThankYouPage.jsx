  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Thank you for choosing TireBuddy. We appreciate your trust and look forward to serving you."
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-dark-50 via-white to-primary-50 flex items-center justify-center px-4 py-20">
        <div
          className="bg-white max-w-lg w-full rounded-3xl shadow-card border border-dark-100 p-10 text-center"
          data-aos="fade-up"
        >
          ...
          <h1 className="text-3xl sm:text-4xl font-heading font-bold text-dark-900 mb-3">
            Thank You for Choosing TireBuddy!
          </h1>
          <p className="text-dark-600 text-lg mb-8">
            Your booking has been received. We'll confirm your appointment shortly — usually within a few hours.
          </p>
          ...
          <div className="mb-8 p-6 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border border-yellow-100">
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <h2 className="text-xl font-semibold text-dark-900">Loved our service?</h2>
            </div>
            <p className="text-dark-600 mb-5">
              A quick Google review goes a long way — it helps your neighbours find us too!
            </p>
            <a
          ...
          <div className="border-t border-dark-100 pt-8">
            <p className="text-dark-600 mb-5">
              While you wait, explore everything TireBuddy has to offer!
            </p>
            <Link
              to="/services"
