    ...
    return (
        <>
            ...
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Professional snow shoveling  across the GTA by a 2-person crew. TireBuddy comes to your home — fast, reliable, and inexpensive ."
                />
            ...
            >
                ...
                <div className="relative z-10 px-6" data-aos="fade-up">
                    ...
                    <p className="text-lg md:text-xl text-slate-100 max-w-2xl mx-auto mb-6">
                        Reliable winter yard clean-up across the <strong>GTA</strong> — keeping your property cleaned and
                        safe.
                    </p>
            ...
            <section className="max-w-5xl mx-auto px-4 py-20 text-slate-700 leading-relaxed">
                <div data-aos="fade-up" data-aos-delay="100">
                    <p className="text-lg mb-6">
                        We offer <strong>fast and reliable snow shoveling services the GTA</strong>,
                        perfect for keeping your property safe and clean in winter. All work is
                        completed by a{" "}
                        <strong>2-person team, depending on the size of the property</strong> and using professional equipment.
                        Our team arrives early{" "}
                        <strong></strong>in the morning after snowfall or in the evening<strong></strong>, depending on your preference and schedule.
                    </p>
                    ...
                    <ul className="list-disc list-inside space-y-2">
                        <li>
                            <strong>Manual snow shoveling</strong>(no heavy machines — safe for your interlock or asphalt)
                        </li>
                        <li> <strong></strong>Pathway, driveway, and walkway clearing<strong></strong></li>
                        <li> <strong></strong>Two salt options available:<strong></strong></li>
                        <li>Standard salt</li>
                        <li>Pet-Friendly salt (safe for pets)</li>
                    </ul>
                    <p className="mt-4 text-slate-600">
                        🟤 <em>Fully equipped to clean your yard</em>
                    </p>
                    ...
                    <ul className="list-disc list-inside space-y-2">
                        <li>Each job takes about 45 minutes to 1.5 hours, depending on the amount of snow and property size.</li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside space-y-2">
                        <li> <strong>Step 1</strong>: Submit a booking form or call us directly.</li>
                        <li> <strong>Step 2</strong>: Our manager confirms your location and preferred cleaning time.</li>
                        <li> <strong>Step 3</strong>: Our team arrives on time — morning after snowfall or evening, as agreed.</li>
                        <li> <strong>Step 4</strong>: We clean snow carefully using shovels to protect your interlock or asphalt.</li>
                        <li> <strong>Step 5</strong>: We apply salt (regular or pet-friendly, your choice).</li>
                        <li> <strong>Step 6</strong>: You inspect the result and pay once everything is complete.</li>
                    </ul>
                    ...
                    <p className="mb-6">
                        We also handle{" "}
                        <strong>
                            large and commercial properties — including plazas, offices, and government buildings.
                        </strong>
                    </p>
